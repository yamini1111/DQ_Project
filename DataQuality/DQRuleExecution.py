...
# MAGIC %run /Workspace/Repos/yusufdidighar@cloudanddatauniverse.com/modernDW_databricks/DataQuality/Utilities
# MAGIC

# COMMAND ----------

# MAGIC %run /Workspace/Repos/yusufdidighar@cloudanddatauniverse.com/modernDW_databricks/DataQuality/DQChecks
